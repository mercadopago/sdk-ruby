...
module Mercadopago
  class RequestOptions
    ...
    def custom_headers=(value)
      raise TypeError, 'Param custom_headers must be a Hash' unless value.is_a?(Hash)
    ...
    def corporation_id=(value)
      raise TypeError, 'Param corporation_id must be a String' unless value.is_a?(String)

      @corporation_id = value
    end

    def integrator_id=(value)
      raise TypeError, 'Param integrator_id must be a String' unless value.is_a?(String)

      @integrator_id = value
    end

    def platform_id=(value)
      raise TypeError, 'Param platform_id must be a String' unless value.is_a?(String)
