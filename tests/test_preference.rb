...
class TestPreference < Minitest::Test
    ...
    def test_method_get_id
        sdk = Mercadopago::SDK.new(access_token="TEST-6130770563612470-121314-d27bbd7363e64c3853f058251cf8fc6e-537031659")
        result = sdk.preference().get(preference_id="537031659-d710347b-7746-4025-b72b-e5be918b91ca")
        assert_equal 200, result[:status]
    end
    ...
    def test_method_put
       ...
       data = {
         ...
         result = sdk.preference().update(preference_id="537031659-e4a79653-8638-490c-a4e5-c39f6f8d9874", data)
         assert_equal 200, result[:status]
